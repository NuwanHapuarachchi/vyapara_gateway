...
class FluidGlassNavigationBar extends StatefulWidget {
  ...
  @override
  State<FluidGlassNavigationBar> createState() => _FluidGlassNavigationBarState();
}
...
class _FluidGlassNavigationBarState extends State<FluidGlassNavigationBar>
  ...
  final List<_NavItem> _items = [
    _NavItem(icon: Icons.folder_outlined, activeIcon: Icons.folder, label: 'Apps'),
                  ...
                  child: Stack(
                    children: [
                      ...
                      AnimatedPositioned(
                        ...
                        left: 14 + (widget.currentIndex * ((MediaQuery.of(context).size.width - 80) / 5)),
                        top: 12,
                            ...
                            return Container(
                              ...
                              decoration: BoxDecoration(
                                ...
                                gradient: RadialGradient(
                                  colors: [
                                    AppColors.accent.withOpacity(0.3 * (1 - _rippleAnimation.value)),
                                    AppColors.accent.withOpacity(0.1 * (1 - _rippleAnimation.value)),
                                    Colors.transparent,
                                  ],
                                ),
                              ),
                                              ...
                                              boxShadow: [
                                                BoxShadow(
                                                  color: AppColors.accent.withOpacity(
                                                    0.3 + (0.2 * math.sin(_waveAnimation.value * 2 * math.pi)),
                                                  ),
                                                  blurRadius: 15,
                                                  spreadRadius: 2,
                                                ),
